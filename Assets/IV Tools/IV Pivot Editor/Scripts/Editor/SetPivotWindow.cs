...
namespace IVSoft
{
    public class SetPivotWindow : EditorWindow
    {
        ...
        private bool SetOnScene
        {
            get
            {
                return EditorPrefs.GetBool("Pivot_UseHandles", true);
            }
            set
            {
                EditorPrefs.SetBool("Pivot_UseHandles", value);
            }
        }
        ...
        private bool SnapToVertex
        {
            get
            {
                return EditorPrefs.GetBool("Pivot_SnapToVertex", false);
            }
            set
            {
                EditorPrefs.SetBool("Pivot_SnapToVertex", value);
            }
        }
        ...
        private bool SaveMeshToFbxFolder
        {
            get
            {
                return EditorPrefs.GetBool("Pivot_UseFBXFolder", true);
            }
            set
            {
                EditorPrefs.SetBool("Pivot_UseFBXFolder", value);
            }
        }
        ...
        private static bool DrawBoundingBox
        {
            get
            {
                return EditorPrefs.GetBool("Pivot_BoundingBox", false);
            }
            set
            {
                EditorPrefs.SetBool("Pivot_BoundingBox", value);
            }
        }
        ...
        private bool UseCustom
        {
            get
            {
                return EditorPrefs.GetBool("Pivot_CustomTransform", false);
            }
            set
            {
                EditorPrefs.SetBool("Pivot_CustomTransform", value);
            }
        }
        ...
        private bool UseCustomPosition
        {
            get
            {
                return EditorPrefs.GetBool("Pivot_CustomPos", false);
            }
            set
            {
                EditorPrefs.SetBool("Pivot_CustomPos", value);
            }
        }
        ...
        private bool UseCustomRotation
        {
            get
            {
                return EditorPrefs.GetBool("Pivot_CustomRot", false);
            }
            set
            {
                EditorPrefs.SetBool("Pivot_CustomRot", value);
            }
        }
        ...
        void MeshClonningGUI()
        {
            ...
            SaveMeshToFbxFolder = EditorGUILayout.Toggle(new GUIContent("Save Mesh to FBX folder?", "Saves cloned mesh to original model folder"), SaveMeshToFbxFolder);
        ...
        void CustomPivotGUI()
        {
            ...
            UseCustom = EditorGUILayout.Toggle(new GUIContent("Use Custom", "Set pivot position and rotation to a custom transform or vector"), UseCustom);

            EditorGUI.BeginDisabledGroup(!UseCustom);

            _trPivot = (Transform)EditorGUILayout.ObjectField(new GUIContent("Custom transform", "The custom transform to set the pivot to"), _trPivot, typeof(Transform), true);
           ...
           /* if (UseCustom)
            ...
            UseCustomPosition = EditorGUILayout.ToggleLeft(new GUIContent("Position", "Use this custom pivot position"), UseCustomPosition);
            ...
            UseCustomRotation = EditorGUILayout.ToggleLeft(new GUIContent("Rotation", "Use this custom pivot rotation"), UseCustomRotation);
            ...
            if (GUILayout.Button(new GUIContent("Set Pivot", "sets the pivot to custom position, rotation or transform")))
            {
                if (_trPivot)
                {
                ...
                {
                    SetPivotToCustom(UseCustomPosition ? _customPosition : _transform.position, UseCustomRotation ? Quaternion.Euler(_customRotation) : _transform.rotation);
                }
            }
        ...
        void SetOnSceneGUI()
        {
            ...
            bool setOnScene = EditorGUILayout.Toggle(new GUIContent("Set On Scene", "Use a gizmo to set the pivot on scene view."), SetOnScene);
            ...
            SnapToVertex = EditorGUILayout.Toggle(new GUIContent("Snap to vertex", "Snap pivot position handle to mesh vertices."), SnapToVertex);
        ...
        void UseBoundingBoxGUI()
        {
            ...
            bool draw = EditorGUILayout.Toggle(new GUIContent("Draw bounding box", "Choose whether to draw bounding box gizmo or not."), DrawBoundingBox);
        ...
        void OnGUI()
        {
            if (_transform)
            {
                ...
                if (GUILayout.Button(new GUIContent(_editPivot ? "Stop editing" : "Start editing", "Starts/Stops editing pivot")))
                {
